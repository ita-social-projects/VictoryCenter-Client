...
ARG REACT_APP_SIGNALR_PDF_REPORTS_URL
ENV REACT_APP_SIGNALR_PDF_REPORTS_URL=$REACT_APP_SIGNALR_PDF_REPORTS_URL
RUN test -n "$REACT_APP_SIGNALR_PDF_REPORTS_URL" || { echo "Missing REACT_APP_SIGNALR_PDF_REPORTS_URL"; exit 1; }
RUN npm run build
