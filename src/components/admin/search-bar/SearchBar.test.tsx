...
jest.mocked(require('../../admin/select/Select').Select).Option = ({ value, name }: any) => (
...
describe('SearchBar component', () => {
    ...
    it('renders no autocomplete options if autocompleteValues is empty', () => {
        render(<SearchBar onChange={onChangeMock} autocompleteValues={[]} placeholder={''} />);
    ...
    it('does not crash if autocompleteValues contains duplicate values', () => {
        ...
        render(<SearchBar onChange={onChangeMock} autocompleteValues={valuesWithDuplicates} placeholder={''} />);
