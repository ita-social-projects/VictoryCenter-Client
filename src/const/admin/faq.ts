export const FAQ_TEXT = {
    ...
    MESSAGE: {
        FAIL_TO_FETCH_FAQ: 'Виникла помилка, не вдалося завантажити часті питання',
        FAIL_TO_FETCH_PAGES: 'Виникла помилка, не вдалося завантажити сторінки',
        FAIL_TO_FETCH_SEARCHED_PAGE: 'Не вдалося знайти вибране часте питання',
        FAIL_TO_REORDER_FAQ: 'Виникла помилка, не вдалося змінити порядок питань',
        DONT_FORGET_TO_ORDER: 'Не забудьте налаштувати порядок відображення питань на сайті',
    },
    ...
    FORM: {
        ...
        MESSAGE: {
            ...
            FAIL_TO_TRANSLATE_FAQ: 'Виникла помилка під час додавання перекладу для частого питання',
            FAIL_TO_UPDATE_TRANSLATION: 'Виникла помилка під час оновлення перекладу для частого питання',
        },
        LABEL: {
            PAGE: 'Сторінка',
