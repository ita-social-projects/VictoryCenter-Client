...
// const mockedFaqApi = FaqApi as jest.Mocked<typeof FaqApi>;
...
//         mockedFaqApi.post.mockResolvedValue({
//             ...mockFaq,
//             ...mockFormData,
//             pageIds: mockFormData.pages.map((p) => p.id),
//         });
//         mockedFaqApi.update.mockResolvedValue({
//             ...mockFaq,
//             ...mockFormData,
//             pageIds: mockFormData.pages.map((p) => p.id),
//         });
...
//             await waitFor(() => {
//                 expect(mockedFaqApi.post).toHaveBeenCalledWith(
...
//             mockedFaqApi.post.mockRejectedValue(new Error('API Error'));
//             render(<FaqModal {...addModeProps} />);
//             simulateFormBecomesValid(); // Enable buttons
...
//             expect(getQuestionModal()).not.toBeInTheDocument();
//             expect(mockedFaqApi.post).not.toHaveBeenCalled();
//             expect(mockOnAddFaq).not.toHaveBeenCalled();
//             expect(mockOnClose).not.toHaveBeenCalled();
//         });
//     });
...
//             await waitFor(() => {
//                 expect(mockedFaqApi.update).toHaveBeenCalledWith(
//                     expect.objectContaining({ id: mockFaq.id, status: VisibilityStatus.Draft }),
//                 );
//             });
...
//             mockedFaqApi.update.mockRejectedValue(new Error('API Error'));
//             render(<FaqModal {...editModeProps} />);
//             simulateFormBecomesValid(); // Enable buttons
