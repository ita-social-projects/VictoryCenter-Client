...
describe('ProgramCategoryModal', () => {
    ...
    const getConfirmationModal = () => screen.queryByTestId('question-modal');
    ...
    const expectModalClosed = () => {
        ...
        expect(getConfirmationModal()).not.toBeInTheDocument();
    };
    ...
    describe('Add mode', () => {
        ...
        describe('Modal closing', () => {
            ...
            it('should show confirmation when closing with changes', () => {
                ...
                expect(getConfirmationModal()).toBeInTheDocument();
                expect(
