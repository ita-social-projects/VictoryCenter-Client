...
describe('ProgramExpensesSection', () => {
    ...
    it('should render loader during initial loading', () => {
        ...
        render(<ProgramExpensesSection exchangeRate={'41.25'} isExchangeRateValid={true} />);
    ...
    it('should drop selected program ids that are no longer present in programs data', async () => {
        const { rerender } = render(<ProgramExpensesSection exchangeRate={'41.25'} isExchangeRateValid={true} />);
        ...
        rerender(<ProgramExpensesSection exchangeRate={'41.25'} isExchangeRateValid={true} />);
    ...
    it('should not show delete icons when not in edit mode', () => {
        render(<ProgramExpensesSection isEditing={false} exchangeRate={'41.25'} isExchangeRateValid={true} />);
    ...
    describe('add and edit flow integration', () => {
        ...
        it('should cancel inline edit when isEditing turns off', () => {
            const { rerender } = render(
                <ProgramExpensesSection isEditing exchangeRate={'41.25'} isExchangeRateValid={true} />,
            );

            fireEvent.click(screen.getByLabelText('Edit record 1'));
            expect(screen.getByLabelText('Accept record 1')).toBeInTheDocument();

            rerender(<ProgramExpensesSection isEditing={false} exchangeRate={'41.25'} isExchangeRateValid={true} />);
        ...
        it('should clear bulk selection and hide bulk selection bar when row edit starts', async () => {
            render(<ProgramExpensesSection exchangeRate={"45"} isExchangeRateValid={true} />);
