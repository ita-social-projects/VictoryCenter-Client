            ...
            <div className="paymentDetails">
                ...
                <div className="paymentLabel">
                    ...
                    <div className="labelWithCopyButton">
                        ...
                        <CopyTextButton textToCopy={UIDSREOU_NUMBER_LABEL} />
                    </div>
                </div>
                <div className="paymentLabel">
                    <h3>{BANK_LABEL}</h3>
                    <div className="labelWithCopyButton">
                        ...
                        <CopyTextButton textToCopy={BANK_NAME_LABEL} />
                    </div>
                </div>
                <div className="paymentLabel">
                    ...
                    <div className="labelWithCopyButton">
                        ...
                        <CopyTextButton textToCopy={IBAN_UAH_NUMBER_LABEL} />
                    </div>
                </div>
                <div className="paymentLabel">
                    ...
                    <div className="labelWithCopyButton">
                        ...
                        <CopyTextButton textToCopy={PAYMENT_DESTINATION_NAME_LABEL} />
                    </div>
                </div>
            </div>
        </div>
