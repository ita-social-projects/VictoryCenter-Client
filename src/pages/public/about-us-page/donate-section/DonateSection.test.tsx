...
describe('DonateSection', () => {
    it('should render section with correct title', () => {
        ...
        expect(screen.getByText(aboutUsUk.DONATE_TITLE)).toBeInTheDocument();
    });

    it('should render subtitle correctly', () => {
        render(<DonateSection />, { wrapper: MemoryRouter });
        expect(screen.getByText(aboutUsUk.DONATE_DETAILS)).toBeInTheDocument();
    });

    it('should render donate button', () => {
        render(<DonateSection />, { wrapper: MemoryRouter });
        expect(screen.getByText(aboutUsUk.DONATE)).toBeInTheDocument();
        expect(screen.getByText(aboutUsUk.DONATE)).toHaveClass('donate-button');
    });

    it('should render "become-a-partner" button correctly', () => {
        render(<DonateSection />, { wrapper: MemoryRouter });
        expect(screen.getByText(aboutUsUk.BECOME_PARTNER)).toBeInTheDocument();
        expect(screen.getByText(aboutUsUk.BECOME_PARTNER)).toHaveClass('partner-button');
    });
