...
export const mockPrograms: Program[] = [
  ...
  },
  {
    ...
    description: "Покращення комунікаційних навичок, моторики та соціалізації для дітей з розладами спектру аутизму.",
  ...
  },
  {
    ...
    description: "Програма для військових з фізичними травмами: підтримка рухливості, баланс, м’язова стабільність.",
    categories: [mockCategories[0]],
    status: "Published",
    img: program3,
  },
  ...
  },
  {
    ...
    description: "Повернення відчуття контролю та безпеки, адаптація до мирного життя через тілесно-орієнтовану терапію.",
  ...
  },
  {
    ...
    description: "Підтримка когнітивного та емоційного розвитку у дітей із синдромом Дауна через рухову активність.",
    categories: [mockCategories[1], mockCategories[2]],
    status: "Published",
    img: program3,
  },
